...
@RequestScoped
public class BookingExecutorResource {
    ...
    public String getNotification(@QueryParam("hotelId") String hotelId,
        ...
        try {
            return bookingExecutorLocal.getNotification(hotelId, reservationId, lastChangeDate, notificationType);
        } catch (Exception e) {
    ...
    public String updateARI(@FormParam("hotelTicker") String hotelTicker,
        ...
        return bookingExecutorLocal.updateARI(hotelTicker, invTickers, startString, endString);
    }
    ...
    public String updateAmount(@FormParam("hotelTicker") String hotelTicker,
                               ...
                               @FormParam("start") String startString,
                               @FormParam("end") String endString) {
        return bookingExecutorLocal.updateAmount(hotelTicker, invTickers, startString, endString);
    }
}