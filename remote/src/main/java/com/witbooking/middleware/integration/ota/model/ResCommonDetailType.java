...
public class ResCommonDetailType {
    ...
    public ResCommonDetailType(final String cardHolderName, final String cardType,
            final String cardCode, final String cardNumber,
            final String expireDate,final Date start, final Date finish,
            final String duration) {
        this.guarantee = new GuaranteeType(cardHolderName, cardType, cardCode,
                cardNumber, expireDate);
        this.timeSpan = new TimeSpan(start,finish,duration);
    }
        ...
        extends DateTimeSpanType
    {
        ...
        public TimeSpan(Date checkIn, Date checkOut, String duration) {
            super(checkIn, checkOut, duration);
        }
