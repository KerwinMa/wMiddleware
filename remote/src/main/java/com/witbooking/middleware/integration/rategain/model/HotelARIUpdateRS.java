...
@XmlRootElement(name = "HotelARIUpdateRS")
public class HotelARIUpdateRS implements RateGainRSInterface {
    ...
    public HotelARIUpdateRS() {
    }

    public HotelARIUpdateRS(ErrorType errorType) {
        this.errors = new ErrorsType(errorType);
    }

    public HotelARIUpdateRS(ErrorsType errorType) {
        this.errors = errorType;
    }

    public HotelARIUpdateRS(ErrorType error, BigDecimal version, String target) {
        this.version = version;
        this.target = target;
        this.errors = new ErrorsType(error);
    }

    public HotelARIUpdateRS(ErrorsType error, BigDecimal version, String target) {
        this.version = version;
        this.target = target;
        this.errors = error;
    }
    
    public HotelARIUpdateRS(BigDecimal version, String target){
