...
public class LengthsOfStayType {
    ...
    public static class LengthOfStay {
        ...
        public static class LOSPattern {
            ...
            public String toString() {
                return Objects.toStringHelper(this)
                        .add("fullPatternLOS", fullPatternLOS)
                        .toString();
            }
        }
        ...
        public String toString() {
            return Objects.toStringHelper(this)
                    .add("losPattern", losPattern)
                    .add("time", time)
                    .add("timeUnit", timeUnit)
                    .add("openStatusIndicator", openStatusIndicator)
                    .add("minMaxMessageType", minMaxMessageType)
                    .toString();
        }
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                .add("lengthOfStay", lengthOfStay)
                .add("arrivalDateBased", arrivalDateBased)
                .add("fixedPatternLength", fixedPatternLength)
                .toString();
    }
}
