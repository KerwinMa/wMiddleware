...
public class AvailStatusMessageType {
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                .add("statusApplicationControl", statusApplicationControl)
                .add("lengthsOfStay", lengthsOfStay)
                .add("bestAvailableRates", bestAvailableRates)
                .add("hurdleRate", hurdleRate)
                .add("delta", delta)
                .add("uniqueID", uniqueID)
                .add("restrictionStatus", restrictionStatus)
                .add("override", override)
                .add("bookingLimitMessageType", bookingLimitMessageType)
                .add("bookingLimit", bookingLimit)
                .add("locatorID", locatorID)
                .add("bookingThreshold", bookingThreshold)
                .add("roomGender", roomGender)
                .add("sharedRoomInd", sharedRoomInd)
                .toString();
    }
    ...
    public static class BestAvailableRates {
        ...
        public String toString() {
            return Objects.toStringHelper(this)
                    .add("bestAvailableRate", bestAvailableRate)
                    .toString();
        }
    ...
    public static class RestrictionStatus {
        ...
        public static final String DEPATURE = "Depature";
...
//            }
        ...
        public String toString() {
            return Objects.toStringHelper(this)
                    .add("maxAdvancedBookingOffset", maxAdvancedBookingOffset)
                    .add("minAdvancedBookingOffset", minAdvancedBookingOffset)
                    .add("restriction", restriction)
                    .add("status", status)
                    .add("sellThroughOpenIndicator", sellThroughOpenIndicator)
                    .toString();
        }
    }
