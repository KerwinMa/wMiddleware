...
public class SourceType {
    ...
    public SourceType(final String userId, final String channelId, final String channelName) {
        this.requestorID = new RequestorID(userId);
        this.bookingChannel = new BookingChannel(channelName, channelId);
        //this.
    }
     ...
     *
     * @return possible object is {@link SourceType.RequestorID }
     */
     ...
     *
     * @param value allowed object is {@link SourceType.RequestorID }
     */
     ...
     *
     * @return possible object is {@link SourceType.Position }
     */
     ...
     *
     * @param value allowed object is {@link SourceType.Position }
     */
     ...
     *
     * @return possible object is {@link SourceType.BookingChannel }
     */
     ...
     *
     * @param value allowed object is {@link SourceType.BookingChannel }
     */
    ...
    public static class BookingChannel {
        ...
        public BookingChannel(final String channelName, final String channelCode) {
            this.companyName = new CompanyNameType(channelName, channelCode);
            this.type = "7";
            this.primary = true;
        }
    ...
    public static class Position {
        ...
        public String toString() {
            return Objects.toStringHelper(this)
                    ...
                    .add("altitudeUnitOfMeasureCode", altitudeUnitOfMeasureCode)
    ...
    public static class RequestorID
        ...
        private static final String RESERVATION_TYPE = "14";


        public RequestorID() {
        }

        public RequestorID(String channelId) {
        ...
        public String toString() {
            return Objects.toStringHelper(this)
                    .add("messagePassword", messagePassword)
                    .toString();
        }
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                ...
                .add("agentSine", agentSine)
                .add("pseudoCityCode", pseudoCityCode)
                .add("isoCountry", isoCountry)
                .add("isoCurrency", isoCurrency)
                .add("agentDutyCode", agentDutyCode)
                .add("airlineVendorID", airlineVendorID)
                .add("airportCode", airportCode)
                .add("firstDepartPoint", firstDepartPoint)
                .add("erspUserID", erspUserID)
