...
public class GuaranteeType {
    ...
    private static final String GUARANTEE_CODE = "Credit Card";

    public enum GuaranteeCode {

        GuaranteeRequired("GuaranteeRequired"),
        None("None"),
        CreditCard_DebitCard_Voucher("CC/DC/Voucher"),
        Profile("Profile"),
        Deposit("Deposit"),
        Prepay("Prepay");
        private final String value;

        GuaranteeCode(final String value) {
            this.value = value;
        }
        ...
        public static GuaranteeCode fromValue(String v) {
            for(GuaranteeCode item : values()){
    ...
    public GuaranteeType(final String cardHolderName, final String cardType,
            final String cardCode, final String cardNumber,
            final String expireDate) {
        if (cardHolderName != null) {
            this.guaranteeCode = GUARANTEE_CODE;
            this.guaranteeType = GuaranteeCode.CreditCard_DebitCard_Voucher.getValue();
            this.guaranteesAccepted = new GuaranteesAccepted(cardHolderName, cardType, cardCode, cardNumber, expireDate);
        }
    }
     ...
     *
     * @return possible object is {@link GuaranteeType.GuaranteesAccepted }
     *
     */
     ...
     *
     * @param value allowed object is {@link GuaranteeType.GuaranteesAccepted }
     *
     */
     ...
     *
     * @return possible object is {@link GuaranteeType.Deadline }
     *
     */
     ...
     *
     * @param value allowed object is {@link GuaranteeType.Deadline }
     *
     */
     ...
     * <CODE>set</CODE> method for the guaranteeDescription property.
     *
     * <p>
     ...
     *
     */
    public GuaranteeCode getGuaranteeCode() {
        return GuaranteeCode.fromValue(guaranteeCode);
    }
     ...
     *
     */
    public void setGuaranteeCode(GuaranteeCode value) {
        this.guaranteeCode = value.getValue();
    }
    ...
    public static class GuaranteesAccepted {
         ...
         * <CODE>set</CODE> method for the guaranteeAccepted property.
         *
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
        ...
        public static class GuaranteeAccepted
            ...
            public GuaranteeAccepted(final String cardHolderName, final String cardType,
                    final String cardCode, final String cardNumber,
                    final String expireDate) {
                super(cardHolderName, cardType, cardCode, cardNumber, expireDate);
            }
