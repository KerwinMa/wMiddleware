...
//    protected List<JAXBElement<?>> textOrImageOrURL;
    ...
    protected List<String> textOrImageOrURL;
     ...
     * 
     */
    public List<String> getTextOrImageOrURL() {
        if (textOrImageOrURL == null) {
            textOrImageOrURL = new ArrayList<String>();
        }
        return this.textOrImageOrURL;
    }

    public void setTextOrImageOrURL(String text){
        ObjectFactory fact = new ObjectFactory();
        textOrImageOrURL = new ArrayList<String>();
//        final JAXBElement<Object> objectJAXBElement = new JAXBElement<String>();
//        objectJAXBElement.setValue(text);
        textOrImageOrURL.add(text);
    }
