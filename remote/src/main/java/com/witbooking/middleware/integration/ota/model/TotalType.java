...
public class TotalType {
    ...
    public TotalType(final float amountBeforeTax, final float amountAfterTax, final String currencyCode) {
        this.amountBeforeTax = amountBeforeTax;
        this.amountAfterTax = amountAfterTax;
        this.currencyCode = currencyCode;
        if (amountBeforeTax != 0 && amountAfterTax != 0) {
            this.taxes = new TaxesType(amountAfterTax - amountBeforeTax, currencyCode);
        }
    }
