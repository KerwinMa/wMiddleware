...
public class HotelReservationIDsType {
     ...
     * <CODE>set</CODE> method for the hotelReservationID property.
     *
     * <p>
    ...
    public static class HotelReservationID {
        ...
        public HotelReservationID(String resIDValue) {
            if (resIDValue != null && !"".equals(resIDValue)) {
                this.resIDValue = resIDValue;
                this.resIDType = Constants.OTA_HOTEL_RES_NOTIF_RS_TYPE_RESERVATION_TYPE;
            }
        }
