 ...
 *       &lt;sequence>
 *         &lt;element name="Error" type="{http://cgbridge.rategain.com/OTA/2012/05}ErrorType" maxOccurs="99"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ErrorsType {
    ...
    /**
     * Constructor initialized list errors with the error given.
     *
     * @param item error to add to errors list.
     */
    public ErrorsType(ErrorType item) {
    ...
    public void addErrorType(final ErrorType item) {
        if (error == null) {
