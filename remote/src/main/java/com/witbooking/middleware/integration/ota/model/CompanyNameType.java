...
public class CompanyNameType {
    ...
    public CompanyNameType(String companyName, String code) {
        this.value = companyName;
        this.code = code;
    }

    public CompanyNameType(final String value, final String division, final String department, 
            final String companyShortName, final String travelSector, final String code,
