...
public class OTAHotelAvailRS implements Serializable {
    ...
    public OTAHotelAvailRS(ErrorsType errors) {
        this.errors = errors;
    }

    public OTAHotelAvailRS(ErrorsType errors, BigDecimal version, String echoToken) {
    ...
    public OTAHotelAvailRS(String echoToken, BigDecimal version, RoomStays roomStays) {
        this.echoToken = echoToken;
        this.version = version;
        this.roomStays = roomStays;
        this.setSuccess(new SuccessType());
    }
    ...
    public static class RoomStays {
        ...
        public RoomStays(List<RoomStay> roomStay) {
