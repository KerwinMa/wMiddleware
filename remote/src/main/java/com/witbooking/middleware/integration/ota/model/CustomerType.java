...
public class CustomerType {
    ...
    public CustomerType(final List<String> givenName, final String surName, 
        ...
        this.personName.add(new PersonNameType(givenName, surName));
        this.telephone = new ArrayList<Telephone>();
        if (telephoneNumber != null) {
            this.telephone.add(new Telephone(telephoneNumber));
        }
     ...
     * <CODE>set</CODE> method for the personName property.
     *
     * <p>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the citizenCountryName property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the physChallName property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the petInfo property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the paymentForm property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the relatedTraveler property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the custLoyalty property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the employeeInfo property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * @return possible object is {@link CompanyNameType }
     *
     */
     ...
     *
     * @param value allowed object is {@link CompanyNameType }
     *
     */
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the additionalLanguage property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public static class Address
         ...
         *
         * @param value allowed object is {@link PersonNameType }
         *
         */
         ...
         *
         * @return possible object is {@link TransferActionType }
         *
         */
         ...
         *
         * @param value allowed object is {@link TransferActionType }
         *
         */
    ...
    public static class CustLoyalty {
         ...
         * <CODE>set</CODE> method for the subAccountBalance property.
         *
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         ...
         * snapshot. Therefore any modification you make to the returned list
         * will be present inside the JAXB object. This is why there is not a
         * <CODE>set</CODE> method for the vendorCode property.
         *
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
        ...
        public static class MemberPreferences {
             ...
             * not a
             * <CODE>set</CODE> method for the additionalReward property.
             *
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
        ...
        public static class SecurityInfo {
             ...
             * list will be present inside the JAXB object. This is why there is
             * not a
             * <CODE>set</CODE> method for the passwordHint property.
             *
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
    ...
    public static class Telephone {
        ...
        /**
         * The PhoneTechType attribute refers to the OTA PTT code list and
         * indicates which type of number is transmitted (phone vs fax). The 2
         * codes to be used are: 1 –Voice 3 –Fax
         *
         */
        ...
        protected String remark;
        /**
         * FormattedInd is MANDATORY. If the partner can use Country and Area
         * codes then it should be set to NO. If country code and area code are
         * passed then they should not appear again in the PhoneNumber field. If
         * the partner cannot use country and area code then entire number is
         * passed in the PhoneNumber field and FormattedInd it should be set to
         * YES if the number needs to be parsed as there is a separation of the
         * different parts or set to NO to indicate that the PhoneNumber field
         * contains the entire phone number without a specific format.
         *
         */
        ...
        @XmlAttribute(name = "ExpireDateExclusiveIndicator")
        protected Boolean expireDateExclusiveIndicator;
        private static final String PHONE_TECH_TYPE_VOICE = "1";
        private static final String PHONE_TECH_TYPE_FAX = "3";
        ...
        public Telephone(String phoneNumber) {
            ...
            this.phoneTechType = PHONE_TECH_TYPE_VOICE;
            this.defaultInd = true;
