...
public class DateTimeSpanType {
    ...
    public DateTimeSpanType(Date checkIn, Date checkOut) {
        final SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        this.start = formatter.format(checkIn);
        this.end = formatter.format(checkOut);
    }

    public DateTimeSpanType(final Date checkIn, final Date checkOut, final String duration) {
        final SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        this.start = formatter.format(checkIn);
        this.end = formatter.format(checkOut);
     ...
     *
     * @return possible object is {@link DateTimeSpanType.StartDateWindow }
     *
     */
     ...
     *
     * @param value allowed object is {@link DateTimeSpanType.StartDateWindow }
     *
     */
     ...
     *
     * @return possible object is {@link DateTimeSpanType.EndDateWindow }
     *
     */
     ...
     *
     * @param value allowed object is {@link DateTimeSpanType.EndDateWindow }
     *
     */
