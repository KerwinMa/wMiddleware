...
public class OTAHotelResNotifRS {
    ...
    public OTAHotelResNotifRS() {
        this.timeStamp = XMLUtils.getXMLGeCalendarFromDate(new Date());
        this.version = BigDecimal.valueOf(2);
    }


    public OTAHotelResNotifRS(ErrorType error) {
        this.timeStamp = XMLUtils.getXMLGeCalendarFromDate(new Date());
        this.version = BigDecimal.valueOf(2);
    ...
    public void addError(ErrorType errorType) {
        if (errors == null) {
            errors = new ErrorsType();
        }
        errors.addError(errorType);
    }
    ...
    public String toString() {
        return "OTAHotelResNotifRS{" +
                ...
                ", errors=" + errors +
                ", resResponseType=" + resResponseType +
                ", echoToken='" + echoToken + '\'' +
                ", timeStamp=" + timeStamp +
                ", target='" + target + '\'' +
