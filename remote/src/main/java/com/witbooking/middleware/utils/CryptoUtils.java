...
public class CryptoUtils {
    ...
    private static final String ENCRYPTION_KEY_128 = "FjM/o5TRnhC5tV5WRvc18Q==";
    ...
    public static void setDecryptedString(String decryptedString) {
        CryptoUtils.decryptedString = decryptedString;
    }
    ...
    public static void setEncryptedString(String encryptedString) {
        CryptoUtils.encryptedString = encryptedString;
    }
